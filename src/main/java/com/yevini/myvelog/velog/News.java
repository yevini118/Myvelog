...
public class News {
    ...
    private final List<PostStat> newPostStats;
    ...
    public News() {
        ...
        this.likesUp = 0;
        this.postsUp = 0;
        this.newPostStats = new ArrayList<>();
    }

    @Builder
    public News(LocalDateTime historyDateTime, int visitsUp, int likesUp, int postsUp, List<PostStat> newPostStats) {
        ...
        this.newPostStats = newPostStats;
    }
}
